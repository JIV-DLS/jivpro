<nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.html"><img class="main-logo" src="{{ asset('storage/admin/img/logo/logo.png') }} " alt="" /></a>
                <strong><a href="index.html"><img src="{{ asset('storage/admin/img/logo/logosn.png') }} " alt="" /></a></strong>
            </div>
                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                            <a class="has-arrow" href="index.html">
								   <span class="educate-icon educate-home icon-wrap"></span>
								   <span class="mini-click-non">Gestion de cour</span>
								</a>
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard v.1" href="index.html"><span class="mini-sub-pro">Dashboard v.1</span></a></li>
                                <li><a title="Dashboard v.2" href="index-1.html"><span class="mini-sub-pro">Dashboard v.2</span></a></li>
                                <li><a title="Dashboard v.3" href="index-2.html"><span class="mini-sub-pro">Dashboard v.3</span></a></li>
                                <li><a title="Présence" href="Présence.html"><span class="mini-sub-pro">Présence</span></a></li>
                                <li><a title="Heure écoulée" href="Hecoulée.html"><span class="mini-sub-pro">Heure écoulée</span></a></li>
                            </ul>
                        </li>--}} 
                        <li>
                            <a title="Landing Page" href="\master" aria-expanded="false"><span class="educate-icon educate-home icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Acceuil</span></a>
                        </li> 
                        <li>
                            <a class="has-arrow" href="navires" aria-expanded="false"><span class="educate-icon fa-book icon-wrap"></span> <span class="mini-click-non">Navires</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Navires" href="navires"><span class="mini-sub-pro">All Navires</span></a></li>
                                <li><a title="Add Navires" href="navires\add"><span class="mini-sub-pro">Add Navires</span></a></li>
                                <li><a title="Edit Navires" href="navires\edit"><span class="mini-sub-pro">Edit Navires</span></a></li>
                                <li><a title="Navires Profile" href="navires\profile"><span class="mini-sub-pro">Navires Profile</span></a></li>
                            </ul>
                        </li>
                       {{--  <li>
