class clientChrono
{
	...
	constructor (id,contener,idindexer)
	{
		...
		this.state=false;
		this.id=id.substr(idindexer);
        this.contener.append('<div class="progress-bar" id="cp'+id+'" data-rest="'+this.target.data('rest')+'" data-percent="60" data-duration="0" data-color="#fff,skyblue"></div>');
		this.target=$('#'+id);
    ...
    static TimeTrimer(Time)
{
    var diff = {} // Initialisation du retour
        Time = Math.floor(Time);             // Nombre de secondes entre les 2 dates
